...
use widgets::{
    ...
    path_or_text_labeled, required_field_label, required_field_note, required_labeled_text,
    required_path_or_text, required_value_rows, responsive_field_width, with_field_width,
};
...
impl App {
    ...
    fn ui_export_content(&mut self, ui: &mut egui::Ui) {
        ...
        self.ui_exporter_specific_fields(ui);
    ...
    fn ui_contacts(&mut self, ui: &mut egui::Ui, enabled: bool) {
        ...
        if enabled {
            self.form.contacts_kind = contacts_kind_from_path(&self.form.contacts);
        }
    }
    ...
    fn ui_exporter_specific_fields(&mut self, ui: &mut egui::Ui) {
        match self.exporter {
