...
Shared model: [message-ir](../../../../docs/maintainers/architecture/message-ir.md). CSV projection: [CSV columns](../../../../docs/src/content/docs/understand-output/csv-columns.md) and [`ir::CSV_HEADERS`](../../../message-ir/src/lib.rs).
...
Source XML/PDU → `ConversationDocument` → [`ir::FormatSink`](../../../message-ir/src/format_sink.rs) (`--format json|jsonl|csv|eml|mbox|xml`; default `json`).
