# --- agentskill.sh ---
# slug: wshobson/python-code-style
# owner: wshobson
# contentSha: 82699ee
# installed: 2026-07-09T21:36:50.872Z
# source: https://agentskill.sh/wshobson/python-code-style
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback wshobson/python-code-style <1-5> [optional comment]
