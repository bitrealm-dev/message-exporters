...
Keep `wtsexporter` beside the desktop app, then gather the applicable files:
...
- Confirm that `wtsexporter` can be found beside the app, through `MESSAGE_EXPORTERS_BIN` or `PATH`, or through `WTSEXPORTER`.
