...
After checking the result, choose the cleaned contacts file in a message exporter that accepts contacts. A missing contacts file usually leaves names unresolved rather than preventing message conversion.
